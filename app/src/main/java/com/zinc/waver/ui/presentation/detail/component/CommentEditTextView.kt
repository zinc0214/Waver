...
fun CommentEditTextView(
    ...
    Row(
        ...
        IconToggleButton(
            ...
            image = if (likedState.value) com.zinc.waver.ui_common.R.drawable.btn_32_like_on else
                com.zinc.waver.ui_common.R.drawable.btn_32_like_off,
            contentDescription = stringResource(id = R.string.likeButtonDesc),
        )

        IconButton(
            onClick = {
                // commentEvent(OpenDetailEditTextViewEvent.MentionButtonClicked)
            },
            modifier = Modifier
                .padding(top = 11.dp, start = 4.dp, bottom = 11.dp)
                .size(32.dp),
            image = com.zinc.waver.ui_my.R.drawable.btn_32_mention,
